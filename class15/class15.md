...
required matching to the metadata file, so let’s remove it here.
...
We want to remove genes that have 0 count values in alll experiments
...
```
    ...
    ## Info: Working in directory /Users/shabnamhamdard/Documents/BIMM143/bimm143_github/class15
